...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'restaurant_productquantity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.Product'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'restaurant', ['ProductQuantity'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'restaurant_productquantity')
    ...
    models = {
        ...
        u'restaurant.order': {
            ...
            'products_qnatity': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['restaurant.ProductQuantity']", 'symmetrical': 'False'}),
